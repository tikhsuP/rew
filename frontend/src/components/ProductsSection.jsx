...
const PRODUCTS = [
{
  ...
  category: 'Ovens',
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_1fb5c11b9-1768475178241.png",
...
},
{
  ...
  category: 'Ovens',
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_1c8dab169-1778101912730.png",
...
},
{
  ...
  category: 'Ovens',
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_166c5fd0c-1778101912680.png",
...
},
{
  ...
  category: 'Ovens',
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_1aa185fe8-1778101911900.png",
...
},
{
  ...
  category: 'Mixers',
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_110169a28-1768682561374.png",
...
},
{
  ...
  category: 'Mixers',
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_1d2e6f40a-1767416743304.png",
...
},
{
  ...
  category: 'Slicers',
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_104a785bc-1778101912456.png",
...
},
{
  ...
  name: 'Air Washer',
  category: 'Utilities',
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_1ca560957-1778101912697.png",
...
},
{
  ...
  category: 'Conveyors',
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_1c1d8f8e6-1778101910853.png",
...
},
{
  ...
  category: 'Conveyors',
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_174c0b55c-1778101912477.png",
...
},
{
  ...
  alt: 'Batch coding conveyor system for labeling and tracking bakery production batches'
},
{
  id: 17,
  name: 'Moulds',
  category: 'Accessories',
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_1f9a7a357-1778101912056.png",
...
},
{
  ...
  name: 'Trays',
  category: 'Accessories',
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_113d58ca6-1778101912144.png",
...
},
{
  ...
  name: 'Bun Rings',
  category: 'Accessories',
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_1734c12f9-1778101912467.png",
...
const ProductCard = ({ product, size, index }) => {
  const sizeClasses = {
  ...
  { product.category ?
    <div
      ...
      {/* Image area */}
      <div className={`relative w-full ${imgHeightClasses[size]} overflow-hidden bg-[#0a0a0a]`}>
        <img
          src={product.image}
          alt={product.alt}
      ...
      {/* Content */}
      <div className="p-4">
        <h3 className={`font-heading font-semibold text-white leading-tight ${titleSizeClasses[size]} group-hover:text-[#C8922A] transition-colors duration-300`}>
          {product.name}
        </h3>
      </div>
    ...
    <div  onClick={() => scrollToSection('contact')}
      ...
      style={{ animationDelay: `${index * 80}ms`, textAlign: "center", alignItems: "center", flexDirection: "column" }}>
      {/* Image area */}
      
      <div className="flex"
       style={{ margin: "3.5vh 3vw"}}>
        <h1 className={`font-heading font-semibold text-white leading-tight text-2xl group-hover:text-[#C8922A] transition-colors duration-300`}>
...
const LAYOUT: Array<{id: number;size: 'hero' | 'large' | 'medium' | 'small';}> = [
{ id: 1, size: 'hero' },
{ id: 2, size: 'medium' },
{ id: 3, size: 'medium' },
{ id: 4, size: 'large' },
